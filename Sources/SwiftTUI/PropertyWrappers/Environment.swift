...
public struct Environment<T>: AnyEnvironment {
   ...
   public var wrappedValue: T {
       get {
           // Gracefully return default when accessed before instantiation or after teardown
           guard let node = valueReference.node else { return EnvironmentValues()[keyPath: keyPath] }
