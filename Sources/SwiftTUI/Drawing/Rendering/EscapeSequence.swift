...
enum EscapeSequence {
  ...
  static let enableFaint = "\u{1b}[2m"
  // Reset intensity (bold/faint)
  static let disableIntensity = "\u{1b}[22m"
  ...
  // Mouse reporting (xterm SGR mode 1006 + basic 1000 press/release)
  static let enableMouseSGR = "\u{1b}[?1006h"
  static let disableMouseSGR = "\u{1b}[?1006l"
  static let enableMouseBasic = "\u{1b}[?1000h"
  static let disableMouseBasic = "\u{1b}[?1000l"
}
